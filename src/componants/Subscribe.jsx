...
const Subscribe = () => {
  return (
    <>
    <h2 className={`${styles.heading} mb-[2.12rem]`}>Subscribe To Newsletter</h2>
    <p className={`${styles.pargraf} ${styles.paddingx}`}>Subscribe to our newsletter to get amazing offers in future.</p>
    <div className={`${styles.flexitems} gap-5 mt-[3.69rem] flex-col md:flex-row`}>
