...
const Speedscooter = () => {
  return (
    <section className={`${styles.paddingx} ${styles.flexCenter} animate__animated  animate__fadeInTopLeft gap-[5rem] w-full flex-wrap `}>
      {stats.map(item => (
        <div key={item.id} className={`${styles.flexCenter} flex-col p-10 border border-black shadow-[0px_13.211169242858887px_26.422338485717773px_0px_rgba(0,0,0,0.06)] rounded-[0.41288rem] border-[0.661px] border-solid border-[#F4F4F4]`}>
