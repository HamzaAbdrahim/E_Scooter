...
const Gallery = () => {
  return (
    <>
    <h2 className={`${styles.heading} mb-[2.12rem]`}>Gallery</h2>
    <p className={`${styles.pargraf}`}>View gallery of our products and make yourself satisfied with our creation.</p>
    <div className='grid grid-cols-1 xl:grid-cols-2 mt-28'>
